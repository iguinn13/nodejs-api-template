...
import { makeValidateRequestPayload } from '../../../../../../main/factories/middlewares/make-validate-request-payload';
import { makeCreateUserController } from '../../../../../../main/factories/controllers/user/make-create-user-controller';
import { makeAuthenticateUserController } from '../../../../../../main/factories/controllers/user/make-authenticate-user-controller';
